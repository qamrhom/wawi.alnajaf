...
git clone https://github.com/qamrhom/wawi.alnajaf.git
...
libpython-dev expat libexpat1-dev -y && cd $HOME && rm -rf wawi.alnajaf && rm -rf .telegram-cli && git clone https://github.com/qamrhom/wawi.alnajaf.git && cd superflux-bot && ./launch.sh install && ./launch.sh
~~~~~
